...
import { myActivityColumns } from "../student-activity/config"; // Reusing the same config
      ...
      <Card className="shadow-sm border-none">
        <CardBody className="p-6">
          <div className="flex items-center gap-2 mb-6">
            ...
            <div>
               <h2 className="text-lg font-semibold">Riwayat Kehadiran (Dosen)</h2>
               <p className="text-xs text-default-500">Daftar kegiatan yang telah Anda hadiri sebagai peserta resmi.</p>
            </div>
          </div>
