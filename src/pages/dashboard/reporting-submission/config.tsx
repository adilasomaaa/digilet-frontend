...
export const reportingSubmissionColumns: Column<any>[] = [
...
export const reportingSubmissionFormFields: FormFieldConfig[] = [
...
export const reportingSubmissionDisplayFields: DisplayFieldConfig<any>[] = [
