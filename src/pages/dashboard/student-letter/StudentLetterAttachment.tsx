...
const StudentLetterAttachment = () => {
  const {studentLetterId} = useParams();
  const {
    items, isLoading, isSubmitting, onSubmit
  } = useLetterAttachment(studentLetterId, undefined);
      ...
      <div className="flex justify-between items-center gap-4 my-4">
        ...
        <div className="flex justify-end mt-4 gap-4 items-center">
          ...
          <Button
            ...
            onPress={() => onSubmit({ content: data, isVisible, studentLetterSubmissionId: Number(studentLetterId) })}
          >
            <SaveIcon size={16} />
...
export default StudentLetterAttachment;